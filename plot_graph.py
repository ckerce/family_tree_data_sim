...
if __name__ == '__main__':
   ...
   data = [
           ...
           {"name": "Ron Weasley", "gender": "Male", "birth_year": 1980, "death_year": 'UNK', "father": "Arthur Weasley", "mother": "Molly Weasley", "spouse": "Hermione Granger", "siblings": ["Ginny Weasley", "Fred Weasley", "George Weasley", "Bill Weasley", "Charlie Weasley", "Percy Weasley"], "children": ["Rose Weasley", "Hugo Weasley"], "cousins": ["Bilius", "Fred II", "Roxanne", "Victoire", "Dominique", "Louis", "Molly II", "Lucy", "Rose", "Hugo", "James II", "Albus Severus", "Lily Luna"]},
           {"name": "Hermione Granger", "gender": "Female", "birth_year": 1979, "death_year": 'UNK', "father": "Mr. Granger", "mother": "Mrs. Granger", "spouse": "Ron Weasley", "siblings": [], "children": ["Rose Weasley", "Hugo Weasley"], "cousins": []},
